...
<head>
    ...
    <meta name="description" content="@yield('meta_description', 'Blog site')" />
    <meta name="author" content="@yield('meta_author', 'Sahal Muhammed')" />
...
<body>
     ...
     <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="index.html">{{ config('app.name') }}
            </a>
